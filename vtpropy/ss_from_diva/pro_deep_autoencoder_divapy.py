...
with tf.device(use_device):
    ...
    decoded = Dense(layer1_dim, activation='sigmoid')(encoded)
    ...
    decoded_afs1 = decoder1.predict(encoded_afs)
    # decoded_afs2 = decoder2.predict(decoded_afs1)
    decoded_afs = decoder3.predict(decoded_afs1)
